 ...
 * Use the [TeamCalendarFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TeamCalendarFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TeamCalendarFragment {
